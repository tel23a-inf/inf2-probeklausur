...
function(ADD_INLINE_TESTS)
    set(options)
    set(one_value_args SRC_FILE_STEM)
    set(multi_value_args TEST_CASES LIBRARIES)
    cmake_parse_arguments("TT" "${options}" "${one_value_args}" "${multi_value_args}" ${ARGN})

    set (SOURCE_NAME ${TT_SRC_FILE_STEM})
    set (TEST_TARGET ${SOURCE_NAME}_test)
    set (TEST_LIB ${SOURCE_NAME}_test_lib)
    set (TEST_SOURCE ${TT_SRC_FILE_STEM}.cpp)
    set (TEST_CASES ${TT_TEST_CASES})
    set (LINK_LIBRARIES ${TT_LIBRARIES})
